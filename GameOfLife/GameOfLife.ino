 ...
 *   -- This is needed even with the frame buffer comparison logic.
 *   -- This is due to the frame buffer comparison comparing altered state of
 *      the game field before reaching the end. There needs to be an OLD Array
 *      that the game can check through before writing to a field.
 *   Game State logic
 *   Music
